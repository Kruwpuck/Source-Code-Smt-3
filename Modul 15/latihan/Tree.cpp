...
adrNode mostLeftNode_103032330054(adrNode root){
    if (root->left == NULL){
        return root;
    }else{
        return mostLeftNode_103032330054(root->left);
    }
}
adrNode mostRightNode_103032330054(adrNode root){
    if (root->right == NULL){
        return root;
    }else{
        return mostRightNode_103032330054(root->right);
    }
}

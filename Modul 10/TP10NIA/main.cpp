...
int main()
{
    ...
    int n;
    infotype X;
    createListJadwal_103032300018(L);
    ...
    for (int i = 0; i < n; i++){
        ...
        cin >> X.Kode;
        cout << endl << "Jenis Penerbangan : ";
        cin >> X.Jenis;
        cout << endl << "Tanggal Penerbangan : ";
        cin >> X.Tanggal;
        cout << endl << "Waktu Penerbangan : ";
        cin >> X.Waktu;
        cout << endl << "Asal Penerbangan : ";
        cin >> X.Asal;
        cout << endl << "Tujuan Penerbangan : ";
        cin >> X.Tujuan;
        cout << endl << "Kapasitas Penerbangan : ";
        cin >> X.Kapasitas;
        adr_jadwalP P = createElemenJadwal_103032300018(X);
        InsertLastJ_103032300018(L, P);
    }
    cout << endl << "========== SEBELUM DELETE FIRST ==========" << endl;
    ShowJadwal_103032300018(L);
    cout << endl << "========== SETELAH DELETE FIRST ==========" << endl;
    adr_jadwalP P;
    // delete Jadwal penerbangan
    DeleteFirstJ_103032300018(L, P);
    ShowJadwal_103032300018(L);
    // Cari jadwal penerbangan dari surabaya ke malang tanggal 9 Desember 2022
    P = SearchJ_103032300018(L, "Surabaya", "Malang", "2022-12-9");
    if (P != NULL){
